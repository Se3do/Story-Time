...
<body>
          ...
          <form class="form" action="" method="post">
            ...
            <div class="credit-card-info--form">
              ...
              <div class="input_container">
                ...
                <input id="password_field" class="input_field" type="number" name="input-Card" title="Inpit title" placeholder="0000 0000 0000 0000">
              </div>
              <div class="input_container">
                <label for="password_field" class="input_label">Expiry Date / CVV</label>
                <div class="split">
                  <input id="password_field" class="input_field" type="text" name="input-expire" title="Expiry Date" placeholder="01/23">
                  <input id="password_field" class="input_field" type="number" name="cvv" title="CVV" placeholder="CVV">
                </div>
              </div>
            </div>
            <div class="price-checkout">
              <label class="price"><sup>$</sup><?php echo $row['Book_price']; ?>.99</label>
              <input class="purchase--btn" type="submit" value="Checkout"></input>
            </div>
          </form>
        </div>
  ...
  if (isset($_POST['submit'])) {
    ...
    $Customer_Full_Name = $_POST['input-name'];
    $Customer_Card_Number = $_POST['input-Card'];
    $expire = $_POST['input-expire'];
    $Customer_Cvv = $_POST['cvv'];

    $sql1 = " INSERT INTO `orders` (`Customer_Mail`, `Book_id`,
 `Customer_Full_Name`, `Order_Card_Number`, `Order_Card_CVV`) VALUES ( '$user_Mail', '$Book_id', '$Customer_Full_Name', '$Customer_Card_Number', '$Customer_Cvv');";
